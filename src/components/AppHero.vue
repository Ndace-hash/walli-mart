<template>
  <section class="hero relative flex items-center w-full md:grid grid-cols-2 gap-4 px-4">
    <div
      class="flex flex-col gap-y-2 justify-center text-center items-center md:items-start text-left"
    >
    ...
    <div class="h-full flex place-items-center overflow-y-hidden object-cover hidden md:flex">
